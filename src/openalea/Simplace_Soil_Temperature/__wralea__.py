...
# -*- coding: latin-1 -*-
# This file has been generated at Tue Jun 17 17:27:55 2025
...
SoilTemperature = CompositeNodeFactory(name='SoilTemperature',
 ...
 '    ShortDescription: None\n'),
   ...
   3: ('amei.soiltemperature.soiltemperature', 'STMPsimCalculator')},
                             elt_connections={  4379539600: (2, 1, '__out__', 0),
   4379539632: (2, 6, '__out__', 1),
   4379539664: (2, 0, '__out__', 2),
   4379539696: (2, 3, '__out__', 3),
   4379539728: (2, 4, '__out__', 4),
   4379539760: (2, 5, '__out__', 5),
   4379539792: (2, 2, '__out__', 6),
   4379539824: (3, 0, '__out__', 7),
   4379539856: (3, 1, '__out__', 8),
   4379539888: ('__in__', 0, 2, 0),
   4379539920: ('__in__', 1, 2, 3),
   4379539952: ('__in__', 2, 2, 1),
   4379539984: ('__in__', 3, 2, 2),
   4379540016: ('__in__', 4, 2, 5),
   4379540048: ('__in__', 5, 2, 6),
   4379540080: ('__in__', 6, 2, 7),
   4379540112: ('__in__', 7, 2, 8),
   4379540144: ('__in__', 8, 2, 9),
   4379540176: ('__in__', 9, 2, 10),
   4379540208: ('__in__', 10, 2, 11),
   4379540240: ('__in__', 11, 2, 12),
   4379540272: ('__in__', 12, 2, 13),
   4379540304: ('__in__', 13, 2, 14),
   4379540336: ('__in__', 14, 3, 0),
   4379540368: ('__in__', 15, 3, 1),
   4379540400: ('__in__', 16, 3, 2),
   4379540432: ('__in__', 17, 3, 3),
   4379540464: ('__in__', 18, 3, 4),
   4379540496: ('__in__', 19, 3, 5),
   4379540528: ('__in__', 20, 2, 4),
   4379540560: ('__in__', 21, 2, 15),
   4379540592: ('__in__', 22, 2, 16),
   4379540624: ('__in__', 23, 2, 17),
   4379540656: ('__in__', 24, 3, 8),
   4379540688: ('__in__', 25, 3, 9),
   4379540720: (2, 1, 3, 6)},
