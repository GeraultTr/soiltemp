...
# -*- coding: latin-1 -*-
# This file has been generated at Tue Jun 17 13:49:15 2025
...
SoilTemperature = CompositeNodeFactory(name='SoilTemperature',
   ...
   5: ('openalea.pylab.plotting', 'PyLabPlot')},
                             elt_connections={  4343543952: (2, 0, 3, 1),
   4343543984: (3, 0, 4, 0),
   4343544016: (4, 0, 5, 1),
   4343544048: (4, 1, 5, 2)},
   ...
   '__out__': {  'block': False,
                 ...
                 'user_application': None,
                 'user_color': None}},
                             elt_value={  2: [(0, "'Montpellier/FR'"), (1, "'SICL'"), (2, "'0.0'"), (3, "'0'")],
   ...
   3: {'position': [3.1776591359573985, 34.7750499815061], 'userColor': None, 'useUserColor': False},
