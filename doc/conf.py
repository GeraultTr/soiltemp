...
html_theme_options = {
    ...
    "icon_links": [
        {
            "name": "GitHub",
            "url": "https://github.com/openalea/soiltemp",
...
htmlhelp_basename = "soiltemp_documentation"
...
man_pages = [(master_doc, "openalea.soiltemp", "SoilTemp Documentation", [author], 1)]
